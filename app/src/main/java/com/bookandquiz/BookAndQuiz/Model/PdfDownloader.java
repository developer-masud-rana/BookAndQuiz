...
import com.bookandquiz.BookAndQuiz.ChapterListActivity;
import com.bookandquiz.BookAndQuiz.Interface.Downloader;
...
public class PdfDownloader implements Downloader {
    ...
    public PdfDownloader(ChapterListActivity context, String url){
    ...
    public String createDirectory() {
        File folder = new File(Environment.getExternalStorageDirectory() + File.separator + "itbangladesh");
        File subFolder = null;
    ...
    private class Data extends AsyncTask<String, String,String> {
        ...
        protected void onPostExecute(String s)
        {
            if(!s.contains("No URL")) {
                ...
                {
                    VideoTitle = "pdfFile" + new Date().toString()+".pdf";
                }
                else {
                    VideoTitle = VideoTitle + ".pdf";
                }
